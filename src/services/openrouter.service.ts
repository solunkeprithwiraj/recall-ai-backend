/**
 * OpenRouter Service
 * Handles all interactions with OpenRouter API for flashcard generation
 */
...
Return ONLY the JSON array, no additional text or markdown formatting.`;
    ...
    try {
      ...
      console.error('Error generating flashcards with OpenRouter:', error);
      throw new Error(
...
Return ONLY the JSON object, no additional text or markdown formatting.`;
    ...
    try {
      ...
      console.error('Error generating study module with OpenRouter:', error);
      throw new Error(
...
export function getOpenRouterService(): OpenRouterService {
  if (!serviceInstance) {
    serviceInstance = new OpenRouterService();
  }
