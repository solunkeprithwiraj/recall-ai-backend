/**
 * Google Gemini API Key Service
 * Handles all interactions with Google Gemini API using API key authentication
 */
...
Return ONLY the JSON array, no additional text or markdown formatting.`;
    ...
    try {
      ...
      console.error('Error generating flashcards with Google Gemini:', error);
      throw new Error(
...
Return ONLY the JSON object, no additional text or markdown formatting.`;
    ...
    try {
      ...
      console.error('Error generating study module with Google Gemini:', error);
      throw new Error(
...
let serviceInstance: GoogleGeminiService | null = null;

export function getGoogleGeminiService(): GoogleGeminiService {
  if (!serviceInstance) {
    serviceInstance = new GoogleGeminiService();
  }
